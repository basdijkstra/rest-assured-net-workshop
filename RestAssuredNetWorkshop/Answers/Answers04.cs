    ...
    public class Answers04 : TestBase
    {
        ...
        public void GetAccountsForCustomer12212AsXml_CheckIdOfFirstAccount_ShouldBe12345()
        {
            ...
            Given()
                ...
                .When()
                .Get("/xml/customers/12212/accounts")
                .Then()
                .StatusCode(200)
                .Body("//account[1]/id", NHamcrest.Is.EqualTo(12345));
        }
        ...
        public void GetAccountsForCustomer12212AsXml_CheckBalanceOfThirdAccount_ShouldBe4321()
        {
            ...
            Given()
                ...
                .Then()
                .StatusCode(200)
                .Body("//account[3]/balance", NHamcrest.Is.EqualTo("43.21"));
        }
        ...
        public void GetSavingsAccountForCustomer12212AsXml_CheckIdAndBalance_ShouldBe98765and10123()
        {
            ...
            Given()
                ...
                .Then()
                .StatusCode(200)
                .Body("//account[@type='savings']/id", NHamcrest.Is.EqualTo(98765))
                .Body("//account[@type='savings']/balance", NHamcrest.Is.EqualTo("10123.00"));
        }
    }
}
